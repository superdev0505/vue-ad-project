    ...
    <section :class="$style.wrapper">
        ...
        <div :class="$style.contentBody">
            <div :class="$style.left">
                <small-list-block sponsoredDeals v-if="category.parent_term.posts" :items="category.parent_term.posts.data" title="Latest Deals" />
                <repeater-list-block v-if="category.posts" :items="category.posts.data" title="Sponsored Deals" />
...
<script>
    ...
    import SmallListBlock from '~/components/Blocks/Lists/SmallListBlock'
    ...
    export default {
        ...
        async asyncData({ params, app, route, error }) {
            ...
            let path = 'best-cell-phone-deals/homepage-featured'
            if (page > 1) {
                path += '/page/' + page
            }
